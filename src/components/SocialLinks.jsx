...
const SocialLinks = () => {
  ...
  return (
    <div className="flex flex-col top-[35%] left-0 fixed">
      <div>
        <button
          className={`xl:hidden pl-2 animate-pulse ${toggle ? "text-green-400" : "text-red-500"}`}
      ...
      {
        <ul className={`duration-[1s] xl:translate-x-[0] transition-all ${toggle ? "translate-x-[-100px]" : "translate-x-[0]"}`}>
